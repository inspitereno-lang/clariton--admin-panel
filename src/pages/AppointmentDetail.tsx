...
import { ChevronLeft, Calendar, Clock, User, Phone, Globe, CheckCircle, XCircle, FileText, MapPin, Store } from 'lucide-react';
                        ...
                        <CardContent className="p-6">
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        <p className="text-sm font-medium text-gray-900">{appointment.store?.name || 'N/A'}</p>
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        <p className="text-sm font-medium text-gray-900">{appointment.store?.address}, {appointment.store?.city}</p>
                                        <p className="text-xs text-gray-500">{appointment.store?.state}, {appointment.store?.zipCode}</p>
                                    </div>
                                </div>
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        <p className="text-sm font-medium text-gray-900">{appointment.store?.contactNumber}</p>
                                        <p className="text-xs text-gray-500">{appointment.store?.email}</p>
                                    </div>
                                </div>
                            </div>
                            {appointment.store?.mapUrl && (
                                <div className="mt-4 pt-4 border-t">
                                    <Button
                                        variant="outline"
                                        size="sm"
                                        className="text-red-600 border-red-200 hover:bg-red-50"
                                        onClick={() => window.open(appointment.store?.mapUrl, '_blank')}
                                    >
